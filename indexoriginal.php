...
<main>
    ...
    <section class="relative overflow-hidden bg-[#f7f8f3]">
        ...
        <div class="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 md:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
    ...
    <!-- Stats -->
    <section class="border-y border-green-100 bg-[#f8fbf8]">
        <div class="mx-auto grid max-w-7xl gap-4 px-4 py-10 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">

            <article class="rounded-[1.4rem] border border-green-500 bg-green-600 p-5 text-white shadow-[0_12px_30px_rgba(22,163,74,0.14)] transition duration-300 hover:-translate-y-1 hover:bg-green-700 hover:shadow-[0_18px_38px_rgba(22,163,74,0.20)]">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-[0.12em] text-green-50/90">
                            Local Markets
                        </p>
                    ...
                    <span class="grid h-14 w-14 place-items-center rounded-2xl border border-white/20 bg-white/15 text-white backdrop-blur">
                        <i class="fa-solid fa-store text-lg"></i>
                    </span>
                </div>

                <p class="mt-4 text-xs leading-5 text-green-50/85">
    ...
    <section class="bg-white py-16 lg:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8">
                <?php foreach ($categories as $category): ?>
                    <a href="<?php echo fm_e(fm_url('products.php?category_id=' . (int) $category['category_id'])); ?>"
                ...
                <a href="<?php echo fm_e($productTargetUrl); ?>"
                   ...
                   class="group block overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-soft transition hover:-translate-y-1 hover:shadow-card">
                    ...
                    <div class="relative h-52 overflow-hidden bg-slate-100">
                        ...
                        <span class="absolute right-3 top-3 grid h-9 w-9 place-items-center rounded-full bg-white/95 text-slate-500 shadow-sm">
    ...
    <section class="bg-white py-16 lg:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative mt-12 grid gap-8 lg:grid-cols-3">
                <div class="absolute left-[16.66%] right-[16.66%] top-10 hidden border-t-2 border-dashed border-green-200 lg:block"></div>

                <article class="relative text-center">
                    <span class="relative z-10 mx-auto grid h-20 w-20 place-items-center rounded-full border-8 border-white bg-green-100 text-green-700 shadow-soft">
                        <i class="fa-solid fa-location-dot text-2xl"></i>
                    </span>

                    <p class="mt-5 text-[10px] font-black uppercase tracking-widest text-green-600">Step 01</p>
                    <h3 class="mt-2 text-lg font-black text-slate-900">Find a nearby market</h3>
                    <p class="mx-auto mt-2 max-w-sm text-sm leading-7 text-slate-500">
                        Search by city, market name or the products you need.
                    </p>
                </article>

                <article class="relative text-center">
                    <span class="relative z-10 mx-auto grid h-20 w-20 place-items-center rounded-full border-8 border-white bg-amber-100 text-amber-700 shadow-soft">
                        <i class="fa-solid fa-basket-shopping text-2xl"></i>
                    </span>

                    <p class="mt-5 text-[10px] font-black uppercase tracking-widest text-green-600">Step 02</p>
                    <h3 class="mt-2 text-lg font-black text-slate-900">Choose fresh products</h3>
                    <p class="mx-auto mt-2 max-w-sm text-sm leading-7 text-slate-500">
                ...
                <article class="relative text-center">
                    <span class="relative z-10 mx-auto grid h-20 w-20 place-items-center rounded-full border-8 border-white bg-blue-100 text-blue-700 shadow-soft">
                        <i class="fa-solid fa-credit-card text-2xl"></i>
                    </span>

                    <p class="mt-5 text-[10px] font-black uppercase tracking-widest text-green-600">Step 03</p>
                    <h3 class="mt-2 text-lg font-black text-slate-900">Order with confidence</h3>
                    <p class="mx-auto mt-2 max-w-sm text-sm leading-7 text-slate-500">
                        Checkout using KBZPay or Wave Money and follow order status.
                    </p>
                </article>
            </div>
        </div>
            ...
            <div class="relative grid items-center gap-8 lg:grid-cols-[1fr_auto]">
                <div>
                    ...
                    <p class="mt-4 max-w-2xl text-sm leading-7 text-green-50/85">
                        Register as a vendor, wait for administrator approval and manage products under your assigned markets.
                    </p>
                </div>
